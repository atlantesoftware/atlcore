...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Node.view_count'
        db.add_column('contenttype_node', 'view_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Node.view_count'
        db.delete_column('contenttype_node', 'view_count')

        # Changing field 'Video.video_url'
        db.alter_column('contenttype_video', 'video_url', self.gf('django.db.models.fields.FilePathField')(path='/var/django/rtv/rtv/files/videosftp', max_length=256))
    ...
    models = {
        ...
        'contenttype.node': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'default': "'a0b830c4580d11e1a9c2000c295674d2'", 'max_length': '36', 'primary_key': 'True'}),
        ...
        'contenttype.video': {
            ...
            'video_url': ('django.db.models.fields.FilePathField', [], {'path': "'/var/workspace/AtlanteSoftware/suenacubano/files/videosftp'", 'max_length': '256', 'blank': 'True'}),
