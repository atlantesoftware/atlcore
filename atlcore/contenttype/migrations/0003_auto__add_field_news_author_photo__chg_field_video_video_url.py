...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'News.author_photo'
        db.add_column('contenttype_news', 'author_photo', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)

        # Changing field 'Video.video_url'
        db.alter_column('contenttype_video', 'video_url', self.gf('django.db.models.fields.FilePathField')(path='/home/ariel/AptanaWorkspace/suenacubano/files/videosftp', max_length=256))


    def backwards(self, orm):
        
        # Deleting field 'News.author_photo'
        db.delete_column('contenttype_news', 'author_photo')

        # Changing field 'Video.video_url'
        db.alter_column('contenttype_video', 'video_url', self.gf('django.db.models.fields.FilePathField')(path='/var/workspace/AtlanteSoftware/suenacubano/files/videosftp', max_length=256))
    ...
    models = {
        ...
        'contenttype.node': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'default': "'d0f53ed284de11e18bd9001cc0b8e64c'", 'max_length': '36', 'primary_key': 'True'}),
        ...
        'contenttype.video': {
            ...
            'video_url': ('django.db.models.fields.FilePathField', [], {'path': "'/home/ariel/AptanaWorkspace/suenacubano/files/videosftp'", 'max_length': '256', 'blank': 'True'}),
