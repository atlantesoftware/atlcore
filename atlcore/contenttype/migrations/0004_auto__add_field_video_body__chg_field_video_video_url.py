...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Video.body'
        db.add_column('contenttype_video', 'body', self.gf('django.db.models.fields.TextField')(default=None), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Video.body'
        db.delete_column('contenttype_video', 'body')
    ...
    models = {
        ...
        'contenttype.node': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'default': "'a4b60d0edbe811e1888a001cc0b8e64c'", 'max_length': '36', 'primary_key': 'True'}),
        ...
        'contenttype.video': {
            ...
            'video_url': ('django.db.models.fields.FilePathField', [], {'path': "'/home/ariel/workspaceHELIOS/sitv/files/videosftp'", 'max_length': '256', 'blank': 'True'}),
