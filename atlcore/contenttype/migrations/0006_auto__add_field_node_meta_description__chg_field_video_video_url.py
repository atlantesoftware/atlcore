...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Node.meta_description'
        db.add_column('contenttype_node', 'meta_description', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Node.meta_description'
        db.delete_column('contenttype_node', 'meta_description')
    ...
    models = {
        ...
        'contenttype.node': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'default': "'6d8ba5e63caa11e2beeed90f1e4b8e66'", 'max_length': '36', 'primary_key': 'True'}),
        ...
        'contenttype.video': {
            ...
            'video_url': ('django.db.models.fields.FilePathField', [], {'path': "'/var/django/suenacubano/suenacubano/files/videosftp'", 'max_length': '256', 'blank': 'True'}),
