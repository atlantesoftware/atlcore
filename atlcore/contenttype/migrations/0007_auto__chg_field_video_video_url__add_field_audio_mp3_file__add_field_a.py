...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('contenttype_video', 'video_url', self.gf('django.db.models.fields.FilePathField')(path='/var/django/osmanigarcia/files/videosftp', max_length=256))

        # Adding field 'Audio.mp3_file'
        db.add_column('contenttype_audio', 'mp3_file', self.gf('django.db.models.fields.files.FileField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'Audio.ogg_file'
        db.add_column('contenttype_audio', 'ogg_file', self.gf('django.db.models.fields.files.FileField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'Audio.wav_file'
        db.add_column('contenttype_audio', 'wav_file', self.gf('django.db.models.fields.files.FileField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'Video.video_url'
        db.alter_column('contenttype_video', 'video_url', self.gf('django.db.models.fields.FilePathField')(path='/var/django/suenacubano/suenacubano/files/videosftp', max_length=256))

        # Deleting field 'Audio.mp3_file'
        db.delete_column('contenttype_audio', 'mp3_file')

        # Deleting field 'Audio.ogg_file'
        db.delete_column('contenttype_audio', 'ogg_file')

        # Deleting field 'Audio.wav_file'
        db.delete_column('contenttype_audio', 'wav_file')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 7, 11, 38, 42, 951558)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 7, 11, 38, 42, 951443)'}),
        ...
        'contenttype.audio': {
            ...
            'mp3_file': ('django.db.models.fields.files.FileField', [], {'default': "''", 'max_length': '100', 'blank': 'True'}),
            'ogg_file': ('django.db.models.fields.files.FileField', [], {'default': "''", 'max_length': '100', 'blank': 'True'}),
            'wav_file': ('django.db.models.fields.files.FileField', [], {'default': "''", 'max_length': '100', 'blank': 'True'})
        },
        'contenttype.banner': {
        ...
        'contenttype.node': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'default': "'375b7bc2714d11e2b419f0def1a2b2d8'", 'max_length': '36', 'primary_key': 'True'}),
        ...
        'contenttype.video': {
            ...
            'video_url': ('django.db.models.fields.FilePathField', [], {'path': "'/var/django/osmanigarcia/files/videosftp'", 'max_length': '256', 'blank': 'True'}),
