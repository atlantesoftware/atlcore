...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('contenttype_video', 'video_url', self.gf('django.db.models.fields.FilePathField')(path='/var/django/lec517/files/videosftp', max_length=256))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 10, 10, 30, 52, 511346)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 10, 10, 30, 52, 511225)'}),
        ...
        'contenttype.node': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'default': "'3c674dae739f11e29bc974e50b6b2106'", 'max_length': '36', 'primary_key': 'True'}),
        ...
        'contenttype.video': {
            ...
            'video_url': ('django.db.models.fields.FilePathField', [], {'path': "'/var/django/lec517/files/videosftp'", 'max_length': '256', 'blank': 'True'}),
