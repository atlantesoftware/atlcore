...
urlpatterns = patterns('',
            url(r'^(?P<id>[a-fA-F0-9]{32})/$', 'atlcore.contenttype.views.details_view', name='news_details2'),
            url(r'^(?P<id>[a-fA-F0-9]{32})/(?P<slug>[a-zA-Z0-9-]+)/$', 'atlcore.contenttype.views.details_view', name='news_details'),
