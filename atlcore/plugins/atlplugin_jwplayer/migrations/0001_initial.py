...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AtlJWPlayer'
        db.create_table('cmsplugin_atljwplayer', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(default=None, max_length=256, null=True)),
            ('video', self.gf('django.db.models.fields.related.ForeignKey')(related_name='plugins', to=orm['contenttype.Video'])),
        ))
        db.send_create_signal('atlplugin_jwplayer', ['AtlJWPlayer'])


    def backwards(self, orm):
        # Deleting model 'AtlJWPlayer'
        db.delete_table('cmsplugin_atljwplayer')
    ...
    models = {
        ...
        'contenttype.node': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'default': "'2a4da78aaeaa11e2b730f0def1a2b2d8'", 'max_length': '36', 'primary_key': 'True'}),
