...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AtlJWPlayer.width'
        db.add_column('cmsplugin_atljwplayer', 'width',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=320),
                      keep_default=False)

        # Adding field 'AtlJWPlayer.height'
        db.add_column('cmsplugin_atljwplayer', 'height',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=240),
                      keep_default=False)

        # Adding field 'AtlJWPlayer.auto_play'
        db.add_column('cmsplugin_atljwplayer', 'auto_play',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AtlJWPlayer.width'
        db.delete_column('cmsplugin_atljwplayer', 'width')

        # Deleting field 'AtlJWPlayer.height'
        db.delete_column('cmsplugin_atljwplayer', 'height')

        # Deleting field 'AtlJWPlayer.auto_play'
        db.delete_column('cmsplugin_atljwplayer', 'auto_play')
    ...
    models = {
        ...
        'atlplugin_jwplayer.atljwplayer': {
            'Meta': {'object_name': 'AtlJWPlayer', 'db_table': "'cmsplugin_atljwplayer'", '_ormbases': ['cms.CMSPlugin']},
            ...
            'video': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'plugins'", 'to': "orm['contenttype.Video']"}),
        ...
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 26, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'contenttype.node': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'default': "'e2d3dd12aead11e28736f0def1a2b2d8'", 'max_length': '36', 'primary_key': 'True'}),
        ...
        'contenttype.video': {
            ...
            'video_url': ('django.db.models.fields.FilePathField', [], {'path': "'/var/django/waldomendoza/files/videosftp'", 'max_length': '256', 'blank': 'True'}),
    ...
    complete_apps = ['atlplugin_jwplayer']