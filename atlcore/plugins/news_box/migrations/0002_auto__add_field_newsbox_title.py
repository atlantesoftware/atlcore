...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NewsBox.title'
        db.add_column('cmsplugin_newsbox', 'title', self.gf('django.db.models.fields.CharField')(default=None, max_length=256, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NewsBox.title'
        db.delete_column('cmsplugin_newsbox', 'title')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 29, 10, 45, 6, 438546)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 29, 10, 45, 6, 438470)'}),
        ...
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 29, 10, 45, 6, 444108)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'contenttype.node': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'default': "'a10b50d6988711e2a42bf0def1a2b2d8'", 'max_length': '36', 'primary_key': 'True'}),
