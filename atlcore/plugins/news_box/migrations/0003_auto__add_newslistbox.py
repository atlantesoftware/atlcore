...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'NewsListBox'
        db.create_table('cmsplugin_newslistbox', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(default=None, max_length=256, null=True)),
            ('max_element', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('paginator', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('news_box', ['NewsListBox'])


    def backwards(self, orm):
        
        # Deleting model 'NewsListBox'
        db.delete_table('cmsplugin_newslistbox')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 4, 6, 8, 18, 14826)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 4, 6, 8, 18, 14697)'}),
        ...
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 4, 6, 8, 18, 13657)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'contenttype.node': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'default': "'f42236069d1711e28afbf0def1a2b2d8'", 'max_length': '36', 'primary_key': 'True'}),
        ...
        'news_box.newslistbox': {
            ...
            'paginator': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'title': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '256', 'null': 'True'})
        },
        'sites.site': {
