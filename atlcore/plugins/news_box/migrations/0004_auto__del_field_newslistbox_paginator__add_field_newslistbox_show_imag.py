...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'NewsListBox.paginator'
        db.delete_column('cmsplugin_newslistbox', 'paginator')

        # Adding field 'NewsListBox.show_image'
        db.add_column('cmsplugin_newslistbox', 'show_image', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'NewsListBox.show_description'
        db.add_column('cmsplugin_newslistbox', 'show_description', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'NewsListBox.show_paginator'
        db.add_column('cmsplugin_newslistbox', 'show_paginator', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'NewsListBox.paginator'
        db.add_column('cmsplugin_newslistbox', 'paginator', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'NewsListBox.show_image'
        db.delete_column('cmsplugin_newslistbox', 'show_image')

        # Deleting field 'NewsListBox.show_description'
        db.delete_column('cmsplugin_newslistbox', 'show_description')

        # Deleting field 'NewsListBox.show_paginator'
        db.delete_column('cmsplugin_newslistbox', 'show_paginator')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 5, 3, 41, 38, 460567)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 5, 3, 41, 38, 460470)'}),
        ...
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 5, 3, 41, 38, 464898)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'contenttype.node': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'default': "'a199a1669dcc11e2afcdf0def1a2b2d8'", 'max_length': '36', 'primary_key': 'True'}),
        ...
        'news_box.newslistbox': {
            'Meta': {'object_name': 'NewsListBox', 'db_table': "'cmsplugin_newslistbox'", '_ormbases': ['cms.CMSPlugin']},
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'max_element': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
