...
from atlcore.schedule.conf.settings import GET_EVENTS_FUNC, OCCURRENCE_CANCEL_REDIRECT
from atlcore.schedule.forms import EventForm, OccurrenceForm
from atlcore.schedule.forms import EventBackendForm, OccurrenceBackendForm
from atlcore.schedule.models import *
from atlcore.schedule.periods import weekday_names
from atlcore.schedule.utils import check_event_permissions, coerce_date_dict
from atlcore.schedule.utils import decode_occurrence, serialize_occurrences

def calendar(request, calendar_slug, template='site/atl_schedule/schedule/calendar.html'):
    """
...
def calendar_by_periods(request, calendar_slug, periods=None,
    template_name="site/atl_schedule/schedule/calendar_by_period.html"):
    """
...
def event(request, event_id, template_name="site/atl_schedule/schedule/event.html"):
    """
...
def occurrence(request, event_id,
    template_name="site/atl_schedule/schedule/occurrence.html", *args, **kwargs):
    """
...
def edit_occurrence(request, event_id,
    template_name="site/atl_schedule/schedule/edit_occurrence.html", *args, **kwargs):
    event, occurrence = get_occurrence(event_id, *args, **kwargs)
...
def cancel_occurrence(request, event_id,
    template_name='site/atl_schedule/schedule/cancel_occurrence.html', *args, **kwargs):
    """
...
def create_or_edit_event(request, calendar_slug, event_id=None, next=None,
    template_name='site/atl_schedule/schedule/create_event.html', form_class = EventForm):
    """
    ...
    Template:
        site/atl_schedule/schedule/create_event.html
...
def delete_event(request, event_id, next=None, login_required=True):
    ...
    return delete_object(request,
                         ...
                         template_name = "site/atl_schedule/schedule/delete_event.html",
...
def event_json(request):
    ...
    rnd = loader.get_template('site/atl_schedule/schedule/event_json.html')
