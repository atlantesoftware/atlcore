...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SiteProfile.google_analytics_script'
        db.add_column('siteprofile_siteprofile', 'google_analytics_script', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SiteProfile.google_analytics_script'
        db.delete_column('siteprofile_siteprofile', 'google_analytics_script')
