...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('siteprofile_siteprofile', 'twitter', self.gf('django.db.models.fields.CharField')(max_length=250))
    ...
    models = {
        'siteprofile.siteprofile': {
            ...
            'twitter': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'})
        },
        'sites.site': {
