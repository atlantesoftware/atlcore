...
class TinyMCE(forms.Textarea):
    ...
    def render(self, name, value, attrs=None):
        ...
        mce_config['width'] = 755
        
        
        if self.mce_attrs and self.mce_attrs['plugin'] and self.mce_attrs['plugin'] == 'guitarchord':            
            mce_config['plugins'] = 'table,spellchecker,paste,searchreplace,guitarchord'
            mce_config['extended_valid_elements'] = 'chord[class]' 
            mce_config['theme_advanced_buttons4'] = 'chordListBox, variationListBox, insert_lyric_button, delete_lyric_button,tablecontrols'
        else:
            mce_config['plugins'] = 'table,spellchecker,paste,searchreplace,imagebrowser'
            mce_config['theme_advanced_buttons4'] = 'chordListBox, variationListBox, insert_lyric_button, delete_lyric_button,tablecontrols'
